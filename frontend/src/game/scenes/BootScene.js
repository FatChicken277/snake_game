...
export default class BootScene extends Scene {
  ...
  create () {
    ...
    let logoText = this.add.text(WIDTH / 2, HEIGHT / 3, "SNAKEE", {font: "150px VT323", shadow: "10px"}).setOrigin(0.5)
    logoText.setShadow(5, 5, 'rgba(0,0,0,0.5)', 15)

    let playText = this.add.text(WIDTH / 2, HEIGHT / 1.8, "PLAY", {font: "50px VT323"}).setOrigin(0.5)
